...
import { Space, TopBar,colors, emages,NetworkCard,Tpins,PaymentModal,Btn,Alerts,useIsReady,LoadingScreen} from '../../../utility';
import { useNavigation } from '@react-navigation/native';
import { Ionicons ,MaterialCommunityIcons,FontAwesome5 } from '@expo/vector-icons';
import { TextInput } from 'react-native-paper';
import * as Haptics from 'expo-haptics';
import Lottie from 'lottie-react-native';
import {BuyCoins, Cables, SellCards, SellCoins} from '../../service';
   ...
   const {refresh,setRefresh}=useContext(StateRefresh);
    ...
    const [Tid, setTid] = useState("");
     ...
     const CompletePayment= async()=>{
         ...
         .then((db)=>{
          ...
          formData.append('brand',Networkid as any)
    ...
    style={{flex:1,backgroundColor:colors.lightgrey,}}>
     <SafeAreaProvider style={{flex:1,backgroundColor:colors.lightgrey,}}>
      <StatusBar/>
      <TopBar Title="Sell GiftCard" Back={true} onClick={()=>navigation.navigate('TradeScreen')}/>
      <SafeAreaView>
       <ScrollView>
       ...
       <Space height={13}/>
         ...
         {NetworkName2==null?(<ActivityIndicator/>):(<>
                  ...
                  <Space height={20}/>
                   <Pressable style={{flexDirection:"row",justifyContent:"space-around"}}>
                    ...
                    <Text style={{color:colors.secondary,fontFamily:"Poppins-Regular",}}>Note</Text>
                      ...
                      Upload a screenshot of your giftcard and use the "Submit" button to complete transaction.
            ...
            <TextInput 
                ...
                label={<Text style={{fontFamily:"Poppins-SemiBold",fontSize:13}}>Enter your giftcard E-code </Text>}
